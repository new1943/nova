...
// Re-export types from nova_core for convenience (pub use only, no private use needed)
pub use nova_core::preflight_types::{PreFlightCheckResult, Complexity};
...
impl PreFlightChecker {
        ...
        let recent: Vec<String> = messages
            ...
            .filter_map(|m| {
                let role = match m.role {
                    ...
                    nova_core::message::Role::Tool => "Tool",
                    nova_core::message::Role::System => "System",
                };
    ...
    fn parse_response(resp: &nova_llm::types::ApiResponse) -> PreFlightCheckResult {
        ...
        match parsed {
            Ok(v) => {
                ...
                PreFlightCheckResult {
                    thinking,
                    topic_shift,
                    complexity: Complexity::parse(complexity_str),
                    reason,
                }
            }
            Err(e) => {
