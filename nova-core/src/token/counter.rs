...
///
/// This provides precise token counting instead of the rough character/4 estimation.
...
pub struct TokenCounter {
    // Using Box<dyn ...> to avoid exposing internal type
...
pub fn init() -> Result<()> {
    // Force initialization by accessing the lazy static
    let _ = *COUNTER;
    Ok(())
}
...
mod tests {
    ...
    fn test_count_tokens() {
        ...
        // Chinese characters (each likely 1-2 tokens)
