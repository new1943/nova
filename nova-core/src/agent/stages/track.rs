...
use crate::memory::{TopicTracker, TensionTracker};
use std::sync::Arc;
...
///
/// 读取 ClassifyStage 的 topic_shift 结果，不重复检测。
/// 写入 tension 到 TurnContext。
