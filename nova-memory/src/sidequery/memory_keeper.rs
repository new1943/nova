...
use tokio::fs;
use nova_core::atomic_write::atomic_write_async;
...
///
/// Lives in nova-memory so it can use SideQuery without circular dependencies.
...
impl MemoryKeeper {
    ...
    async fn process_buffer(
        ...
        atomic_write_async(&memory_path, updated.as_bytes()).await?;
